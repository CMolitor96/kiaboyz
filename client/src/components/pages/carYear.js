    ...
    if (width < breakpoint) {
        return (
            <div>
                ...
                <div className='d-flex flex-row flex-wrap justify-content-center'>
                    <Link key={model} className='retreat' style={{ margin: '1rem' }} to={`/search/${make}`}>Go Back to Model</Link>
                </div>
        ...
        return (
            <div>
                ...
                <div className='d-flex flex-row flex-wrap justify-content-center'>
                    <Link key={model} className='retreat' to={`/search/${make}`}>Go Back to Model</Link>
                </div>
                <div className='d-flex flex-row flex-wrap justify-content-center'>
                    {carYear.map((year) => {
                        return (
